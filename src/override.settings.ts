...
export function overrideSettingsByActor(
    setting: Partial<ISettings>,
): Partial<ISettings> {
    switch (setting.actorID) {
        case 'nativo/apify-ntv-actor-simple-screenshot':
            ...
            log.info('Overriding settings for actor', {
                runInEachActor: setting.runInEachActor,
                parallelRunsCount: setting.parallelRunsCount,
            });
